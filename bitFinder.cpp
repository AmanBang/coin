...
std::string int_to_string(uint256_t number) {
  std::stringstream ss; 
  ss << number; 
  return ss.str(); 
}
...
std::string pflh_key( uint256_t value) {
    std::stringstream ss;
...
// 66 : 13zb1hQbWVsc2S7ZTZnP2G4undNNpdh5so - 2832ed74f2b5e35ee
    ...
    uint256_t re_start = stringToHex(start_value.substr(1));
